...
static void test()
{
    ...
    {
        constexpr auto t00 = cast<Millikelvin>(0_degC);
        constexpr auto x00 = t00.count_internal();
        constexpr auto v00 = 273150.0;
        static_assert(x00 == v00);

        constexpr auto t01 = cast<DegFahrenheit>(0_degC);
        constexpr auto x01 = (0_degC).count<DegFahrenheit>(); // t01.count_internal();
        constexpr auto v01 = 32.0;
        static_assert(x01 == v01);

        constexpr auto t02 = cast<DegRankine>(0_degC);   // t_R = 9/5 t_C + 491.67
        constexpr auto x02 = t02.count_internal();
        constexpr auto v02 = 491.67;
        static_assert(x02 == v02);

        constexpr auto t03 = cast<DegReaumur>(0_degC);
        constexpr auto x03 = t03.count_internal();
    ...
    {
        constexpr auto t00 = cast<Kelvin>(100_degC);
        constexpr auto x00 = t00.count<Kelvin>();
        constexpr auto v00 = 373.15;
        static_assert(x00 == v00);

        constexpr auto t01 = cast<DegFahrenheit>(100_degC);
        constexpr auto x01 = t01.count_internal();
        constexpr auto v01 = 212.0;
        static_assert(x01 == v01);

        constexpr auto t02 = cast<DegRankine>(100_degC);
        constexpr auto x02 = t02.count_internal();
        constexpr auto v02 = 100.0 * (9.0 / 5.0) + 491.67; // ~671.67
        static_assert(x02 == v02);

        constexpr auto t03 = cast<DegReaumur>(100_degC);
        constexpr auto x03 = t03.count_internal();
    ...
    {
        constexpr auto t00 = cast<Kelvin>(32_degF);
        constexpr auto x00 = t00.count_internal();
        constexpr auto v00 = 273.15;
        static_assert(x00 == v00);

        constexpr auto t01 = cast<DegCelsius>(32_degF);
        constexpr auto x01 = t01.count_internal();
        constexpr auto v01 = 0.0;
        static_assert(x01 == v01);

        constexpr auto t02 = cast<DegRankine>(32_degF);
        constexpr auto x02 = t02.count_internal();
        constexpr auto v02 = 491.67;
        static_assert(x02 == v02);

        constexpr auto t03 = cast<DegReaumur>(32_degF);
        constexpr auto x03 = t03.count_internal();
        constexpr auto v03 = 0.0;
        static_assert(x03 == v03);
    }
    ...
    {
        constexpr auto t00 = cast<Kelvin>(0_degRe);
        constexpr auto x00 = t00.count_internal();
        constexpr auto v00 = 273.15;
        static_assert(x00 == v00);

        constexpr auto t01 = cast<DegCelsius>(0_degRe);
        constexpr auto x01 = t01.count_internal();
        constexpr auto v01 = 0.0;
        static_assert(x01 == v01);

        constexpr auto t02 = cast<DegRankine>(0_degRe);
        constexpr auto x02 = t02.count_internal();
        constexpr auto v02 = 491.67;
        static_assert(x02 == v02);

        constexpr auto t03 = cast<DegFahrenheit>(0_degRe);
        constexpr auto x03 = t03.count_internal();
    ...
    {
        constexpr auto t00 = cast<Kelvin>(80_degRe);
        constexpr auto x00 = t00.count_internal();
        constexpr auto v00 = 373.15;
        static_assert(x00 == v00);

        constexpr auto t01 = cast<DegCelsius>(80_degRe);
        constexpr auto x01 = t01.count_internal();
        constexpr auto v01 = 100.0;
        static_assert(x01 == v01);

        constexpr auto t02 = cast<DegRankine>(80_degRe);
        constexpr auto x02 = t02.count_internal();
        constexpr auto v02 = 80.0 * 2.25 + 491.67; // ~671.67
        static_assert(x02 == v02);

        constexpr auto t03 = cast<DegFahrenheit>(80_degRe);
        constexpr auto x03 = t03.count_internal();
...
//  static_assert(h2.count<HeightLocal>() == 123.0);
    ...
    constexpr HeightAboveSeaLevel h2 = cast<HeightAboveSeaLevel>(h1);
    static_assert(h2.count_internal() == 323.0);
    static_assert(h2.count<HeightLocal>() == 123.0);
